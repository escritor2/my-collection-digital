...
use App\Repositories\Modules\ReadingGoal\ReadingGoalRepository;
use App\Services\Modules\ReadingGoal\ReadingGoalService;
use App\Repositories\Modules\ReadingStreak\ReadingStreakRepository;
use App\Services\Modules\ReadingStreak\ReadingStreakService;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ReadingGoalRepositoryInterface::class, ReadingGoalRepository::class);
        $this->app->bind(ReadingStreakRepositoryInterface::class, ReadingStreakRepository::class);
        ...
        $this->app->bind(ReadingGoalServiceInterface::class, ReadingGoalService::class);
        $this->app->bind(ReadingStreakServiceInterface::class, ReadingStreakService::class);
    }
